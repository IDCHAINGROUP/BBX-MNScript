...
# Copyright (c) 2019-2022 The Ballotbox developers
...
TEMP_PATH=$(mktemp -d)
USER='ballotbox'
CONFIG_FILENAME='ballotbox.conf'
DATADIR_PATH='/home/ballotbox/.ballotbox'
COIN_DAEMON='ballotboxd'
COIN_CLI='ballotbox-cli'
INSTALL_PATH='/usr/local/bin'
COIN_TGZ_URL='https://github.com/IDCHAINGROUP/BBX/releases/download/3.0.0/bbx-3.0.0-linux.tar.gz'
COIN_NAME='Ballotbox'
COIN_NAME_SHORT='ballotbox'
COIN_PORT=1750
RPC_PORT=1751
...
## Generated by Ballotbox script masternode.sh ${SCRIPT_VERSION}
[Unit]
...
function print_logo() {
  echo -e "\n${BGREEN}BALLOTBOX MASTERNODE INSTALLATOR${NC}"
}
